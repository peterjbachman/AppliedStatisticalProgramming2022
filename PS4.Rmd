...
tweets_filtered$text[order(tweets_filtered$retweet_count, decreasing = TRUE)[1:5]]

# Top 5 retweets based on favorite count
tweets_filtered$text[order(tweets_filtered$favorite_count, decreasing = TRUE)[1:5]]
```
